...
export default function AddExpenseForm({ onSubmit, initialValues }: AddExpenseFormProps) {
    ...
    >
      ...
      >
        ...
        <View style={styles.buttonRow}>
          <Button 
            mode="outlined" 
            onPress={() => !loading && clearForm()}
            style={[
              styles.button, 
              { marginRight: 8, borderColor: theme.colors.outline }
            ]}
          ...
          >
            {loading ? (initialValues ? 'Updating...' : 'Adding...') : (initialValues ? 'Update Expense' : 'Add Expense')}
          </Button>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
